...
class ReportsContract extends Contract {
    async init(ctx) {
        ...
        for (const record of records) {
            ...
            console.log('init compositeKey :',compositeKey);
    ...
    async putRecord(ctx, id, name, price, dateString) {
        ...
        console.log('putRecord compositeKey :',compositeKey);

        const recordBytes = await ctx.stub.getState(compositeKey);
        console.log('putRecord recordBytes :',recordBytes);
    ...
    async getAnnualReport(ctx, year) {
        ...
        console.log('getAnnualReport queryString :',queryString);
    ...
    async _getResultsForQueryString(ctx, queryString) {
        ...
        console.log('_getResultsForQueryString iteratorPromise :',iteratorPromise);
